...
public class FacultyChatListFragment extends Fragment {
    ...
    public FacultyChatListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_chats_people, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        msgRV = view.findViewById(R.id.chats_recycler_view);
    ...
    public void BuildRV(List<SenderReciverPojo> senderReciverPojos) {
        FacultyChatListAdapter chatFriendListAdaper = new FacultyChatListAdapter(senderReciverPojos, getActivity());
